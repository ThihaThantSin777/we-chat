...
class MomentDaoImpl extends MomentDAO{
  ...
  @override
  Stream<List<MomentVO>?> getMomentVoListStreamEvent() =>Stream.value(getMomentVOList());

  @override
  MomentVO? getSingleMomentVO(int id)=>_getMomentVOBox().get(id);

  @override
  Stream<MomentVO?> getSingleMomentVoStreamEvent(int id) =>Stream.value(getSingleMomentVO(id));
